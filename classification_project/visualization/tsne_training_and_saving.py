...
# Save the t-SNE model to a file
print("1")
tsne_model_path = r'C:\Users\Rut Katzir\PycharmProjects\AMAT-project\classification_project\visualization\tsne_model2.pkl'
#classification_project/visualization/tsne_new_img.py
with open(tsne_model_path, 'wb') as f:
    print("2")
    pickle.dump(embedding_train, f)
    print("3")